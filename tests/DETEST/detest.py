...
def A1():
    diffeq = lambda t, y: -y
    init = lambda: (tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor(1., dtype=tf.float32))
...
def A5():
    ...
    init = lambda: (tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor(4., dtype=tf.float32))
...
def B1():
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([1., 3.], dtype=tf.float32)
...
def B2():
    ...
    A = tf.convert_to_tensor([[-1., 1., 0.], [1., -2., 1.], [0., 1., -1.]], dtype=tf.float32)
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([2., 0., 1.], dtype=tf.float32)
...
def B3():
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([1., 0., 0.], dtype=tf.float32)
...
def B4():
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([3., 0., 0.], dtype=tf.float32)
...
def B5():
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([0., 1., 1.], dtype=tf.float32)
...
def C1():
    ...
    def init():
        y0 = np.zeros(10)
        y0[0] = 1
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor(y0, dtype=tf.float32)
...
def C5():
    ...
    k2 = tf.convert_to_tensor(2.95912208286, dtype=tf.float32)
    m0 = tf.convert_to_tensor(1.00000597682, dtype=tf.float32)
    ...
    def init():
        ...
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.stack([y0, dy0], 0)
...
def _DTemplate(eps):
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([1 - eps, 0, 0, math.sqrt((1 + eps) / (1 - eps))], dtype=tf.float32)
...
def E1():
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([.671396707141803, .0954005144474744], dtype=tf.float32)
...
def E2():
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([2., 0.], dtype=tf.float32)
...
def E3():
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([0., 0.], dtype=tf.float32)
...
def E4():
    ...
    def init():
        return tf.convert_to_tensor(0., dtype=tf.float32), tf.convert_to_tensor([30., 0.], dtype=tf.float32)
