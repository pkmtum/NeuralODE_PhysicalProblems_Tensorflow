...
for model in ['odenet', 'densenet', 'node-e2e', 'lstm']:
    ...
    for file in files:
        path = 'plots/single_pendulum/' + model + '/' + file
    ...
    print('--------------------------------')
    print('MAX')
    print('          ', [x[:5] for x in csv.columns.values])
