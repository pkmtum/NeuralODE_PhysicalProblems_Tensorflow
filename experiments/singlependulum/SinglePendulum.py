...
class SinglePendulum(tf.keras.Model):
    ...
    def __init__(self, l=1., theta=0., theta_dt=0., g=9.81):
        """
        # Arguments:
        ...
        """
        self.l = l
        self.x = tf.stack([theta, theta_dt], axis=-1)
        self.g = g
    ...
    def total_energy(self):
        return self.l*(1-tf.math.cos(self.x[0]))*self.g + 0.5*(self.l*self.x[1])*(self.l*self.x[1])
