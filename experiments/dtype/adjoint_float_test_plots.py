...
ax.set_yscale('log')
plt.grid(True)
plt.savefig('plots/dtype/adjoint_float_test_rtol_error.pdf')
plt.close()
...
ax.set_yscale('log')
plt.grid(True)
plt.savefig('plots/dtype/adjoint_float_test_walltime_error.pdf')
plt.close()
...
ax.set_yscale('log')
plt.grid(True)
plt.savefig('plots/dtype/adjoint_float_test_nn_rtol_error.pdf')
plt.close()
...
ax.set_yscale('log')
plt.grid(True)
plt.savefig('plots/dtype/adjoint_float_test_nn_walltime_error.pdf')
plt.close()
